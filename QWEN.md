...
For this project, you will use the following specialized agents for different aspects of development:

- **Auth Agent**: Handle all authentication-related tasks, including implementing Better Auth for user signup/signin functionality with JWT token support
- **Frontend Agent**: Develop the responsive frontend interface using Next.js 16+ with App Router
- **DB Agent**: Design and manage database schema and operations using Neon Serverless PostgreSQL with SQLModel ORM
- **Backend Agent**: Develop RESTful API endpoints using Python FastAPI framework
